...
test("root command returns requestError for createThreadRequest when agent does not exist", async () => {
...
test("root command handles deleteAgentRequest and returns deleted status", async () => {
